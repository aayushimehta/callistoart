...
public final class payment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<li class=\"active\">Payment & Delivery Details</li>\n");
      out.write("\t\t\t</ol>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("        <!-- //breadcrumbs -->\n");
      out.write("        <!-- mail -->\n");
      out.write("\t<div class=\"mail animated wow zoomIn\" data-wow-delay=\".5s\">\n");
      out.write("\t\t<div class=\"container\">\n");
      out.write("\t\t\t<h3>Checkout Details</h3>\n");
      out.write("\t\t\t<p class=\"est\">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia \n");
      out.write("\t\t\t\tdeserunt mollit anim id est laborum.</p>\n");
      out.write("\t\t\t<div class=\"mail-grids\">\n");
      out.write("\t\t\t\t<div class=\"col-md-8 mail-grid-left animated wow slideInLeft\" data-wow-delay=\".5s\">\n");
      out.write("\t\t\t\t\t<form>\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" placeholder=\" Your Name\" required=\"\">\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" placeholder=\"Mobile Number\" required=\"\">\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" placeholder=\"Your Floor/House No./Flat\" required=\"\">\n");
      out.write("                                                <input type=\"text\" placeholder=\"Your Colony/Street/Locality\" required=\"\">\n");
      out.write("                                                <input type=\"text\" placeholder=\"Your Town or City\" required=\"\">\n");
      out.write("                                                <input type=\"text\" placeholder=\"Your State\" required=\"\">\n");
      out.write("                                                <select id=\"paymentmode\" name=\"paymentmode\" class=\"frm-field required sect\">\n");
      out.write("                                                    <option>--Select a Payment Method--</option>\n");
      out.write("                                                    <option>Transfer to SBI Account</option>\n");
      out.write("                                                    <option>Cash On Delivery</option>\n");
      out.write("                                                    <option>Pay via Paytm or Freecharge</option>\n");
      out.write("                                                </select>\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" value=\"Place Order\" name=\"placeorder\" >\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-md-4 mail-grid-right animated wow slideInRight\" data-wow-delay=\".5s\">\n");
      out.write("\t\t\t\t\t<div class=\"mail-grid-right1\">\n");
      out.write("\t\t\t\t\t\t<h4>Final Bill <span>Rs.</span></h4>\n");
      out.write("\t\t\t\t\t\t<ul class=\"phone-mail\">\n");
      out.write("\t\t\t\t\t\t\t<li><i class=\"glyphicon glyphicon-earphone\" aria-hidden=\"true\"></i>Phone: +1234 567 893</li>\n");
