...
public final class listofsellers_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("                ");
                    ...
                    {  
                        ...
                        if(myresult.next())
                        {
                            ...
                            out.print("<table class='table table-striped'>"+"<thead>" +"<th>Serial No.</th>"+"<th>Seller ID</th>"+"<th>Business Name</th>"+"<th>Seller Name</th>"+"<th>Email ID</th>"+"</tr></thead>");
                           
                            do
                            {
                                out.print("<tbody><tr><td>"+count+"</td><td>"+myresult.getString("sellerid")+myresult.getString("sname")+"</td><td>"+myresult.getString("businessname")+myresult.getString("email")+"</td><td>"+"</td></tr></tbody>");
                                count++;
                            }
                            while(myresult.next());
                            count++;
